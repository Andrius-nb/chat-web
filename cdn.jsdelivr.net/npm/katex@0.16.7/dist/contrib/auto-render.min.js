            ...
            var e = n(771)
              ...
              , o = function(e, t) {
                for (var n, i = [], o = new RegExp("(" + t.map((function(e) {
                    ...
                    if (-1 === (n = r(t[l].right, e, t[l].left.length)))
                        break;
              ...
              , l = function(e, r) {
                ...
                for (var i = document.createDocumentFragment(), a = 0; a < n.length; a++)
                    if ("text" === n[a].type)
                        ...
                        try {
                            r.preProcess && (d = r.preProcess(d)),
                            t().render(d, l, r)
                        } catch (e) {
                            if (!(e instanceof t().ParseError))
                                throw e;
                            r.errorCallback("KaTeX auto-render: Failed to parse `" + n[a].data + "` with ", e),
              ...
              , d = function e(t, r) {
                for (var n = 0; n < t.childNodes.length; n++) {
                    ...
                    if (3 === i.nodeType) {
                        for (var a = i.textContent, o = i.nextSibling, d = 0; o && o.nodeType === Node.TEXT_NODE; )
                            a += o.textContent,
                            o = o.nextSibling,
                            d++;
                        var s = l(a, r);
                        ...
                        1 === i.nodeType && function() {
                            var t = " " + i.className + " ";
                            -1 === r.ignoredTags.indexOf(i.nodeName.toLowerCase()) && r.ignoredClasses.every((function(e) {
